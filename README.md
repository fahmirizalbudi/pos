<div align="center">
<a href="https://github.com/fahmirizalbudi/pos" target="blank">
<img src="https://github.com/JjagoKoding/icon/blob/main/pos.png?raw=true" width="280" alt="Logo" />
</a>
<br/>
...
2. **Open the project:**
   ...
   > Double-click the `.sln` (Solution) file to open it in Visual Studio.
   ```

3. **Database configuration:**

   ```bash
   > Open MySQL and create a new database (e.g., `PosDb`).
   > Open DB.cs and update the Connection String.
   ```
...
4. **Restore packages:**
   ...
   > Click Restore to download necessary dependencies.
   ```
